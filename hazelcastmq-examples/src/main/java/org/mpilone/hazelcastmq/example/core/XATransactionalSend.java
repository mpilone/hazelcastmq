 ...
 * @author mpilone
 */
public class XATransactionalSend extends ExampleApp {

  private final ILogger log = Logger.getLogger(XATransactionalSend.class);

  private final String queueName = "/queue/transactional.send.example";

  public static void main(String[] args)  {
    XATransactionalSend app = new XATransactionalSend();
    app.runExample();
  }
  ...
  private static class ClusterNode {
    ...
    public XAHazelcastMQContext createXAContext() {
      XAHazelcastMQContext mqContext = mqInstance.createXAContext();
      mqContext.start();
      return mqContext;
    }
